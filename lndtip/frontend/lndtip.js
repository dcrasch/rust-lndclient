...
var requestUrl = "https://www.hacklab.nl/lndtip/"
    ...
    if (!requestPending) {
        ...
        if (tipValue.value !== "") {
            if (!isNaN(tipValue.value)) {
                    ...
                    if (request.readyState === 4) {
                        try {
                            ...
                            if (request.status === 200) {
                                console.log("Got invoice: " + json.bolt11);
                                console.log("Invoice expires in: " + json.expiry);
                                console.log("Got rHash of invoice: " + json.r_hash);

                                console.log("Starting listening for invoice to get settled");

                                listenInvoiceSettled(json.r_hash);
                                ...
                                document.getElementById("lightningTipOpen").onclick = function () {
                                    location.href = "lightning:" + json.bolt11;
                                };
                ...
                request.open("POST", requestUrl + "createinvoice", true);
