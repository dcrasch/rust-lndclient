...
pub struct ChannelCloseSummary {
    ...
    #[prost(enumeration = "channel_close_summary::Initiator", tag = "11")]
    ...
    #[prost(enumeration = "channel_close_summary::Initiator", tag = "12")]
...
pub struct OpenStatusUpdate {
    ...
    #[prost(bytes, tag = "4")]
    pub pending_chan_id: std::vec::Vec<u8>,
    #[prost(oneof = "open_status_update::Update", tags = "1, 3")]
...
pub struct FundingShim {
    #[prost(oneof = "funding_shim::Shim", tags = "1")]
...
pub struct FundingTransitionMsg {
    #[prost(oneof = "funding_transition_msg::Trigger", tags = "1, 2")]
...
pub mod lightning_client {
        ...
        <T::ResponseBody as HttpBody>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = "SendPayment dispatches a bi-directional streaming RPC for sending payments"]
        #[doc = "through the Lightning Network. A single RPC invocation creates a persistent"]
        #[doc = "bi-directional stream allowing clients to rapidly send payments through the"]
        #[doc = "Lightning Network with a single persistent connection."]
